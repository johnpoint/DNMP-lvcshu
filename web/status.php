    ...
    <div class="mdui-typo">
      <div class="container content">
        <div id="loading-notice">
          <noscript>
            <div class="alert alert-danger" style="text-align: center;">
              <strong>Enable JavaScript</strong>you fucking autist neckbeard, it\'s not gonna hurt you.</div></noscript>
          <div class="progress progress-striped active">
            <div class="progress-bar progress-bar-warning" style="width: 100%;">Loading...</div></div>
          <div style="text-align: center;">If this message doesn\'t disappear make sure that you have Javascript enabled.
        ...
        <table class="table table-striped table-condensed table-hover">
          ...
          <tbody id="servers">
            <!-- Servers here \o/ --></tbody>
        </table>
        <br />
        <div id="updated">Updating...</div></div>
